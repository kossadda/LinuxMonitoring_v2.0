...
output_result() {
  ...
  bold "\n${BOLD}Reported ${YELLOW}5${RESET} ${BOLD}log files for ${YELLOW}${EXECUTE_TIME}${RESET} ${BOLD}seconds\n"

  echo -e "${BOLD}All reports you can find in ${YELLOW}${SCRIPT_DIR}/reports${RESET}"
...
generate_status() {
  echo -ne "\rIn progress... Reported ${YELLOW}${1}${RESET} logs"
}
